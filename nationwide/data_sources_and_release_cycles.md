...
| 조달청 나라장터 공사공고 정보 | `data/raw/phase122_pps_bid_notices_robust/`, `nationwide/outputs/pps_construction_nationwide_*_robust_*.csv` | 공공데이터포털 / 조달청 나라장터 입찰공고정보서비스 | 공공공사 입찰공고의 공고명·수요기관·공사지역·예산/추정금액 기반 건설업 보조 활동자료. 2021년 4~7월은 `numRows=100` 기준 완전월 확보 | 공고 발생 시 수시 공개. API 응답이 커서 page 단위 완전성 감사가 필수 |
...
| 현재 상태 | 2021년 4~7월 `numRows=100` robust cache 완전월 확보. 2021년 4~6월은 전체 48,114건, 시군구 정확 귀속 40,792건, 약 107,330억원. 2021년 7월은 전체 12,322건, 시군구 정확 귀속 10,587건, 약 32,304억원 |
