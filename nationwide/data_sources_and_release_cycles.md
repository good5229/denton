...
| 조달청 나라장터 공사공고 정보 | `data/raw/phase122_pps_bid_notices_robust/`, `nationwide/outputs/pps_construction_nationwide_*_202104_202106_robust_202104_202106_complete.csv` | 공공데이터포털 / 조달청 나라장터 입찰공고정보서비스 | 공공공사 입찰공고의 공고명·수요기관·공사지역·예산/추정금액 기반 건설업 보조 활동자료. 2021년 4~6월은 `numRows=100` 기준 완전월 확보 | 공고 발생 시 수시 공개. API 응답이 커서 page 단위 완전성 감사가 필수 |
...
| 조달청 공사공고 정보 | 입찰공고 발생 후 공개되는 수시 자료. 공고일은 GVA 발생시점과 다를 수 있음 | `공사공고 텍스트 기반 지역 귀속 공공공사 예산/추정금액·공고수`로만 사용한다. 2021년 6월 단독 미세혼합은 guardrail 통과, 2021년 1~6월 누적은 최대오차율 악화로 미채택이므로 운영 route가 아니라 보조 후보로 보관한다. |
...
| 현재 상태 | 2021년 4~6월 `numRows=100` robust cache 완전월 확보. 2021년 4~6월은 전체 48,114건, 시군구 정확 귀속 40,792건, 약 107,330억원 |
| 현재 성능 판정 | 2021년 6월 단독 미세혼합은 guardrail 통과, 2021년 1~6월 누적은 최대오차율 악화로 미채택 |
