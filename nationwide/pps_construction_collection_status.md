...
Phase254에서 승인·키 업데이트 후 `202108` page 34~35를 재시도했지만 page 34에서 다시 `HTTP 429`가 발생했다. 2026-07-29 21:06 KST Phase257 no-raw smoke에서도 `202108` page 34, 100행 요청과 공사계약 `20161001` 1행 요청이 모두 `HTTP 429`로 차단됐다. 따라서 2021년 8월은 계속 불완전월이며, 성능감사와 route ranking에는 투입하지 않는다.
