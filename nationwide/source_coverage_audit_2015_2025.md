...
생성시각: 2026-07-29T16:53:34+09:00
...
| source_id | label | exists | rows | period_min | period_max | year_min | year_max | province_count | sigungu_count | index_base | expected_scope | coverage_status | pps_months_complete | pps_complete_periods | pps_first_incomplete_period | notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| pps_contract_info | 조달청 나라장터 공사계약 정보 | True | 132 | 201501 | 202512 | 2015 | 2025 |  |  | amount_not_index | nationwide_public_contracts | blocked_api_incomplete | 21 |  | 201610 | API 429로 전량 미완료. 공공공사 계약액이지 전체 건설업 actual이 아니다. |
