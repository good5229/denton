...
생성시각: 2026-07-29T15:08:06+09:00
...
| source_id | label | exists | rows | period_min | period_max | year_min | year_max | province_count | sigungu_count | index_base | expected_scope | coverage_status | notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| pps_contract_info | 조달청 나라장터 공사계약 정보 | True | 132 | 201501 | 202512 | 2015 | 2025 |  |  | amount_not_index | nationwide_public_contracts | blocked_api_incomplete | API 429로 전량 미완료. 공공공사 계약액이지 전체 건설업 actual이 아니다. |
